...
const Projects = () => {
  ...
  return (
    <div className="mt-24 flex flex-col items-center justify-center">
      ...
      <section className="w-full h-[600px] my-[180px] md:max-w-[680px] md:h-[400px] lg:max-w-[800px] ">
...
const Project = ({
  ...
  return (
    <div className="p-8 md:h-auto w-full h-full flex items-center justify-center gap-10 md:gap-0 flex-col md:flex-row">
      <div className="w-[95%] relative flex-shrink-0 h-[300px] shadow-[0px_0px_38px_0px_rgba(57,158,218,0.2)] rounded-[20px] md:w-[300px] md:mr-8 ">
        <Link href={url}>
          <Image
            src={imageUrl}
            alt={title}
